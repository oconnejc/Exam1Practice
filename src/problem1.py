...
def run_test_problem1a():
    ...
    # ------------------------------------------------------------------
    # Test 3:
    expected = 1.3045  # This is APPROXIMATELY the correct answer.
    answer = problem1a(32,75)
    print()
    print('Test 3 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 4:
    expected = -.5323 # This is APPROXIMATELY the correct answer.
    answer = problem1a(9,17)
    print()
...
def run_test_problem1b():
    ...
    answer = problem1b(4,10)
    print()
    print('Test 3 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 4:
    expected = 14  # This is APPROXIMATELY the correct answer.
    answer = problem1b(5,11)
    print()
    print('Test 4 expected:', expected, '(approximately)')
    print('       actual:  ', answer)
